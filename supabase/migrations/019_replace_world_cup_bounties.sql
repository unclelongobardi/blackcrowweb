...
-- Refresh legacy official bounties (VEXORA copy, current thin targets).
update bounties set
  market_id = '2537856',
  title = 'KLGA field op — June 15 · 76–77°F YES',
  description = 'Official VEXORA · NYC daily weather · YES ~22% · ~$106 volume · resolves on Wunderground KLGA — a book one operator can move.',
...
update bounties set
  ...
  description = 'Official VEXORA · Fed cut by Oct ''26 · YES ~14% · narrative coord on a contested macro lane (not a pure arb play).',
...
update bounties set
  ...
  description = 'Official VEXORA · NYC 78–79°F bucket · YES ~35% · ~$245 volume · same-day capture window on KLGA.',
...
insert into bounties (
  ...
  (
    ...
    'Official VEXORA · HK daily high 30°C · YES ~53% · ~$8.4k volume · contested weather book.',
  ...
  (
    ...
    'Official VEXORA · Chicago O''Hare daily high · YES ~31% · ~$168 volume · ultra-thin Midwest weather book.',
  ...
  (
    ...
    'Official VEXORA · Chicago 74–75°F bucket · YES ~23% · ~$308 volume · alternate thin lane on same event.',
  ...
  (
    ...
    'Official VEXORA · SOL above $70 on June 14 · YES ~13% · ~$303 volume · crypto daily strike you can nudge.',
  ...
  (
    ...
    'Official VEXORA · Announcers say "Eye poke" on CBS/Paramount+ · YES ~47% · ~$13 volume · mention micro-book.',
  ...
  (
    ...
    'Official VEXORA · Announcers say "Armbar" on English feed · YES ~48% · near-zero volume · pure mention book.',
  ...
  (
    ...
    'Official VEXORA · HK daily high 29°C · YES ~31% · ~$18k volume · adjacent bucket to the 30°C lead.',
  ...
  (
    ...
    'Official VEXORA · SOL above $80 on June 15 · YES ~0.7% · ~$222 volume · tail strike, small size can reprice.',
