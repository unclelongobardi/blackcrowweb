-- Official VALORE seed bounties (real Polymarket markets, display SOL — escrow simulated).

alter table bounties add column if not exists is_official boolean not null default false;

-- Official VALORE profile
...
values (
  ...
  'valore_official',
  'VALORE',
  'Official bounties from the network. Real Polymarket targets. SOL rewards held in escrow.',
  'valore_official',
  10000,
  true,
...
insert into bounties (
  ...
  (
    ...
    'Official VALORE · Polymarket weather · YES ~14% · ~$2.4k volume · resolves on Wunderground KLGA daily high for June 10.',
    ...
    'action',
    'open',
    '4k8BmN2xR9pQ7vW3yH6jL1cF5tD0aE8uI6oP3sK7mN2bV9xZ1wQ4rT7yU0hG3jF5kL8nM1pVlreOfficial001',
    'Vlre7vKp2mN9xQ4wR8tY3uI6oP1sL5nM0bV7xZ2wQ9kH',
    true,
    now(),
    '2026-06-11T04:00:00+00'
  ...
  (
    ...
    'Official VALORE · Fed cut by Oct ''26 meeting · YES ~14% · ~$51k volume · macro book worth a coordinated NO-side narrative.',
    ...
    'coord',
    'open',
    '5nM2bV9xZ1wQ4rT7yU0hG3jF5kL8nM1pVlreOfficial0028BmN2xR9pQ7vW3yH6jL1cF5tD0aE8uI6oP3',
    'Vlre7vKp2mN9xQ4wR8tY3uI6oP1sL5nM0bV7xZ2wQ9kH',
    true,
    now(),
    '2026-10-29T20:00:00+00'
  ...
  (
    ...
    'Official VALORE · June 9 NYC 82–83°F bucket · resolves on Wunderground KLGA · same-day capture window.',
    ...
    'intel',
    'open',
    '6oP3sK7mN2bV9xZ1wQ4rT7yU0hG3jF5kL8nM1pVlreOfficial0034k8BmN2xR9pQ7vW3yH6jL1cF5tD0aE',
    'Vlre7vKp2mN9xQ4wR8tY3uI6oP1sL5nM0bV7xZ2wQ9kH',
    true,
    now(),
    '2026-06-10T04:00:00+00'
