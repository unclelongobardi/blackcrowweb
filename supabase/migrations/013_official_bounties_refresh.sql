-- Refresh official VALORE bounties: market-aligned deadlines, clear tasks, updated copy.
...
update bounties set
  ...
  description = 'Official VALORE · Polymarket weather · YES ~14% · ~$2.4k volume · resolves on Wunderground KLGA daily high for June 10.',
...
update bounties set
  ...
  description = 'Official VALORE · Fed cut by Oct ''26 meeting · YES ~14% · ~$51k volume · macro book worth a coordinated NO-side narrative.',
...
update bounties set
  ...
  description = 'Official VALORE · June 9 NYC 82–83°F bucket · resolves on Wunderground KLGA · same-day capture window.',
