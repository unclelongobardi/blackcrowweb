...
const EARN_RULES = [
  ...
  },
  {
    ...
    gloria: "Variable",
    detail: "When you deposit SOL and the bounty opens: initial SOL × 5 GLORIA score (max 300).",
  },
  {
    action: "Complete a bounty",
    gloria: "Variable",
    detail: "When the creator approves your proof: total pool SOL × 10 GLORIA score (max 500).",
  },
  {
    ...
    <div className="mx-auto max-w-5xl px-4 py-5 sm:px-5 sm:py-6">
      <header className="mb-5 sm:mb-6">
        ...
        <p className="mt-1 max-w-lg text-[13px] leading-relaxed text-muted sm:text-[14px]">
          Live rankings — then expand below if you want the full GLORIA score breakdown.
        </p>
      </header>
      ...
      <section className="mt-6 space-y-3 sm:mt-8">
        ...
        <AccordionSection
          title="What is GLORIA score?"
          summary="Reputation points on the leaderboard — separate from SOL bounties."
        >
          <p className="text-[13px] leading-relaxed text-muted">
            GLORIA score measures activity and influence on GLORIA. Bounty rewards are real on-chain payouts;
            the score is status, rank, and visibility on Leaderboard and in search.
          </p>
        </AccordionSection>

        <AccordionSection
          title="How to earn GLORIA score"
            ...
            {EARN_RULES.map((rule) => (
              ...
              >
                <div className="flex items-start justify-between gap-2">
                  ...
                  <span className="shrink-0 font-mono text-[12px] font-bold text-bull">{rule.gloria}</span>
                </div>
        ...
        >
          <ul className="space-y-3 text-[12.5px] leading-relaxed text-muted sm:text-[13px]">
            <li>
              ...
              GLORIA score. GLORIA score does not decay today.
            </li>
            <li>
              <span className="font-semibold text-foreground">Bounty pool</span> — anyone can add SOL while a bounty
              is open or in progress. Helper payout and helper GLORIA score scale with the full pool. Only the creator
              approves or rejects proof.
            </li>
            <li>
              <span className="font-semibold text-foreground">Example</span> — post 1 SOL → up to 5 GLORIA score when
              live. Others add 0.5 SOL → pool is 1.5 SOL. Helper gets 1.5 SOL + up to 15 GLORIA score on approval.
            </li>
            <li>
              <span className="font-semibold text-foreground">Cabals</span> — ranked by member count, not GLORIA score.
